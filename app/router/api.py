...
from app.controllers.task_controller import action_create_task_record, action_create_task_predict, action_create_task_upload, action_create_task_delete, action_execute_record_sample, action_execute_predict, action_execute_record_api, action_execute_upload
...
router.add_api_route("/v0/create-task-delete",action_create_task_delete,response_model=dict,methods=["GET"])
