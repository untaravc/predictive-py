...
from app.controllers.ip_api_controller import point_seach, point_interpolated_sample, sensor_list, predictions, collect_interpolated,access_interpolated_data_ip, generate_value_record, set_normal_value, consume_unit3_lstm, run_unit1_lstm_final, post_interpolated_data_ip
...
router.add_api_route("/v0/consume-unit-1",run_unit1_lstm_final,response_model=dict,methods=["GET"])
